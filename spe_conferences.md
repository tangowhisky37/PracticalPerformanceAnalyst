...
![CMG]({{ "/assets/img/cmg.jpg" | absolute_url }})
...
![ICPE]({{ "/assets/img/icpe.jpg" | absolute_url }})
...
![ACM Sigmetrics]({{ "/assets/img/acm_sigmetrics.png" | absolute_url }})
...
![SIGSOFT]({{ "/assets/img/sigsoft.gif" | absolute_url }})

ACM SigSoft events and conferences include &#8211;

  * <a href="http://www.icse-conferences.org/" target="_blank">International Conference On Software Engineering</a>
  * <a href="http://www.sigsoft.org/fse22/" target="_blank">International Symposium On The Foundations of Software Engineering</a>
  * <a href="http://ase2014.org/" target="_blank">Automated Software Engineering Conference</a>
  * <a href="http://issta2014.org/" target="_blank">International Symposium on Software Testing & Analysis</a>
  * <a href="http://esec-fse15.dei.polimi.it/" target="_blank">European Software Engineering Conference</a>
  * <a href="http://cbse-conferences.org/2014/" target="_blank">International Symposium on Component Based Software Engineering</a>
  * <a href="http://softeng.polito.it/ESEIW2014/ESEM/index.html" target="_blank">International Symposium on Empirical Software Engineering & Management</a>
  * <a href="http://www.modelsconference.org/" target="_blank">International Conference on Model Driven Languages & Systems</a>
  * <a href="http://cseweb.ucsd.edu/paste2010/" target="_blank">Workshop on Program Analysis for Software Tools & Engineering</a>
  * <a href="http://icpe2014.ipd.kit.edu/" target="_blank">International Conference On Performance Engineering</a>
...
![HIPC]({{ "/assets/img/hipc.png" | absolute_url }})
...
![JAX]({{ "/assets/img/jax.gif" | absolute_url }})
...
Many large-scale software systems (e.g., e-commerce websites, telecommunication infrastructure and enterprise systems, etc.) must service hundreds, thousands or even millions of concurrent requests. Many field problems of these systems are due to their inability to scale to field workloads, rather than feature bugs. In addition to conventional functional testing, these systems must be tested with large volumes of concurrent requests (called the _load_) to ensure the quality of these systems. _Large-scale testing_ includes all different objectives and strategies of testing large-scale software systems using load. Examples of large-scale testing are live upgrade testing, load testing, high availability testing, operational profile testing, performance testing, reliability testing, stability testing and stress testing.

![Large Scale Testing]({{ "/assets/img/large_scale_testing.png" | absolute_url }})
...
![OmniTI Surge]({{ "/assets/img/omni_ti_surge.png" | absolute_url }})
...
![QCon]({{ "/assets/img/qcon.gif" | absolute_url }})
...
![RAPIDO]({{ "/assets/img/rapido.png" | absolute_url }})
...
![SuperComputing]({{ "/assets/img/supercomputing.jpg" | absolute_url }})
...
![TPCTP]({{ "/assets/img/tpctc.png" | absolute_url }})
...
![ValueTools]({{ "/assets/img/value_tools.png" | absolute_url }})
...
![Oreilly Velocity]({{ "/assets/img/velocity.jpeg" | absolute_url }})
...
WebPerfDays follows the &#8220;Unconference&#8221; format that Brings the Web Performance Community Together. WebPerfDays uses a mixed format that combinesÂ _**formal presentations**_, ignite sessions, and the _**open**_ _**spaces**_ format.

![WebPerfDays]({{ "/assets/img/webperfdays.png" | absolute_url }})

For more information please <a href="http://www.webperfdays.org" target="_blank">Click Here</a>.

**Copyright Notices &#8211;** All the images on this page are copyright of their original authors and organizations. Please visit the website of the relevant organizations to learn more about their copyright policies including terms and conditions of use.

Hope you have enjoyed the content on this page. Please send us your thoughts, inputs and comments using the chat interface below.
